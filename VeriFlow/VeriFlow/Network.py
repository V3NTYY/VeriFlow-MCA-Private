		...
		for ec in ecs:
			...
			for host in self.hosts.values():
				...
				while (True):
					...
					print("Next switch is now current switch")
					print("Current switch", currentSwitch)
